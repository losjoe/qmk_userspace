...
[QWERTY] = LAYOUT_ansi_84(
     ...
     LT(EXTEND, KC_BSPC),  MT(MOD_LGUI, KC_A), MT(MOD_LALT, KC_S), MT(MOD_LSFT, KC_D), MT(MOD_LCTL, KC_F),     KC_G,     KC_H,     MT(MOD_RCTL, KC_J), MT(MOD_RSFT, KC_K), MT(MOD_LALT, KC_L), MT(MOD_RGUI, KC_SCLN),  KC_QUOT,            KC_ENT,             KC_HOME,
     KC_LSFT,               KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            CW_TOGG,  KC_UP,    KC_END,
     KC_LGUI,     KC_LALT,  KC_LCTL,                                LT(SYM, KC_SPC),                                 MO(MOUSE), MO(MOD2), LGUI(LSFT(KC_S)),  KC_LEFT,  KC_DOWN,  KC_RGHT),
...
[COLEMAK] = LAYOUT_ansi_84(
     ...
     LT(EXTEND, KC_BSPC),  MT(MOD_LGUI, KC_A),  MT(MOD_LALT, KC_R),  MT(MOD_LSFT, KC_S),  MT(MOD_LCTL, KC_T),  KC_G,  KC_M,  MT(MOD_RCTL, KC_N),  MT(MOD_RSFT, KC_E),  MT(MOD_LALT, KC_I),  MT(MOD_RGUI, KC_O),  KC_QUOT,            KC_ENT,  KC_HOME,
...
[MOUSE] = LAYOUT_ansi_84(
     _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
     _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
     _______,  _______,  KC_BTN2,  KC_MS_U,  KC_BTN1,  KC_WH_U,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
